...
if __name__ == "__main__":
    ...
    # Shashank's Way to Create 100 Prompts
    n_predictions = 100
    templates = np.random.choice(template_prompts, n_predictions)
    labels    = np.random.choice(classes, n_predictions)
    prompts = list(map(lambda t, l: t.format(l), templates, labels))
    # ----
